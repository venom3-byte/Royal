export const GAME_WIDTH=1280;export const GAME_HEIGHT=720;export const WORLD_MIN=-12000;export const WORLD_MAX=12000;
export const DAY_LENGTH=300;export const SEASON_LENGTH=600;
